...
const EntireForum = () => {
    ...
    return (
        <Box className={styles.entireForumContainer}>
            <Box className={styles.adminPickWrapper} onClick={handleOpen}>
                <Box>
            ...
            <Box className={styles.forumListContainer}>
                <Box className={styles.forumList} onClick={handleOpen}>
            ...
            <JoinChatRoomModal open={open} onClose={handleClose} />
        </Box>
    );
};
